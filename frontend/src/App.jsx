...
const App = () => {
  const { authUser, checkAuth , isCheckingAuth } = useAuthStore(); // destructuring the auth user
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/" element={authUser ? <HomePage /> : <Navigate to="/login" />} /> {/* if the user is not loggedin then navigate tologin in page*/ }
